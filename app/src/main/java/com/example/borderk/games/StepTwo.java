...
public class StepTwo extends Fragment {
    ...
    public static StepTwo newInstance(String gameId) {
        StepTwo frag = new StepTwo();
        Bundle b = new Bundle();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_value_card_two, container, false);
    }
...
//        infoText.setText("Step 2 — Game ID: " + gameId + " (Timed)");
    }
}